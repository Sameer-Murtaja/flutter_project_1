...
class AppColor {
  ...
  static LinearGradient bottomShadow = LinearGradient(colors: [Color(0xFF107873).withAlpha(20), Color(0xFF107873)], begin: Alignment.bottomCenter, end: Alignment.topCenter);
  static LinearGradient linearBlackBottom = LinearGradient(colors: [Colors.black.withAlpha(45), Colors.black], begin: Alignment.bottomCenter, end: Alignment.topCenter);
